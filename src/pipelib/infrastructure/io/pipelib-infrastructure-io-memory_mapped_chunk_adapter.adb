...
package body Pipelib.Infrastructure.IO.Memory_Mapped_Chunk_Adapter is
   ...
   is
      ...
      Actual_Start : constant Storage_Count :=
        Storage_Count'Min (Start_Offset, File_Size);
   ...
   begin
      ...
      while Current_Offset < Actual_End loop
         declare
            Remaining       : constant Storage_Count :=
            ...
            Is_Final        : constant Boolean :=
              Current_Offset + This_Chunk_Size >= Actual_End;
   ...
   exception
      when E : others =>
         return
           Chunk_Vector_Result.Err
             (To_Unbounded_String
                ("Failed to create chunks from memory map: "
   ...
   is
      ...
      subtype Target_Array is
        Stream_Element_Array (1 .. Stream_Element_Offset (Length));
      ...
      Result : constant Stream_Element_Array_Access :=
